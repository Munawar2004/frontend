...
const Navbar = () => {
    ...
    const [defaultAddressArea, setDefaultAddressArea] = useState(
        localStorage.getItem("defaultAddressArea") || null
    );
...
const handleOrdersClick = async () => {
    ...
    const handleSetDefaultAddress = (id, area) => {
        localStorage.setItem("defaultAddressId", id);
        localStorage.setItem("defaultAddressArea", area);
        setDefaultAddressId(id);
        setDefaultAddressArea(area);
    };
                ...
                <div className="nav-left">
                    ...
                    <div className="address-section">
                        ...
                        <button
                            ...
                            onClick={() => setAddressDropdownVisible(!addressDropDownVisible)}
                        >
                            ▼
                        </button>
